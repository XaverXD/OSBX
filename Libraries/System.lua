...
function system.updateDesktop()
	...
	local MineOSContextMenu = desktopMenu:addContextMenuItem("OSBX created by Xaver", 0x000000)
	MineOSContextMenu:addItem(localization.aboutSystem).onTouch = function()
		...
		local lines = {
			...
			"Andrey Kakoito",
			"Maxim Omelaenko",
			"Konstantin Mayakovskiy",
			"Ruslan Isaev",
			"Eugene8388608",
			" ",
			"Special Thanks:",
			" ",
			"Osu! (maybe I'll create a minecraft version)",
			"My coffee addiction for allowing me to stay awake for so long",
			"",
			"Thank you for using OSBX",
		}
