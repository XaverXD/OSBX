...
local repositoryURL = "https://raw.githubusercontent.com/XaverXD/OSBX/master/"
local installerURL = "Installer/"
local EFIURL = "EFI/Minified.lua"

local installerPath = "/OSBX installer/"
...
local installerMenu = menu:addContextMenuItem("OSBX", 0x2D2D2D)
...
addStage(function()
	...
	if not selectedFilesystemProxy.getLabel() then
		selectedFilesystemProxy.setLabel("OSBX HDD")
	end
